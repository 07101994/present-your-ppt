...
//AppCompactPPTxViewer.AppCompactPPTViewer pptViewer;
AppCompactPPTViewer pptViewer;
	//	PPTViewer pptViewer;
...
//		//}
		//else{
			Toast.makeText(this, "hassan rockie", Toast.LENGTH_SHORT).show();
		...
		//}
		Toast.makeText(this, "hassan rockie1", Toast.LENGTH_SHORT).show();
				...
				if(grantResults[0]==PackageManager.PERMISSION_GRANTED){
					...
					if (i != null) {
						...
						if (uri != null) {
							...
							path = Environment.getExternalStorageDirectory() + File.separator + "p.pptx";
							try {
								CopyRAWtoSDCard(R.raw.p, path);
							} catch (IOException e) {
								e.printStackTrace();
								Log.e("Error", e.getMessage());
							}
...
//                    finish();return;
					...
					pptViewer.setNext_img(R.drawable.next).setPrev_img(R.drawable.prev)
							...
							.setZoomin_img(R.drawable.zoomin)
							.setZoomout_img(R.drawable.zoomout);
					pptViewer.loadPPT(MainActivity1.this, path);
